# AWS EKS aws-node-termination-handler Terraform module
...
A terraform module to deploy [aws-node-termination-handler](https://github.com/aws/aws-node-termination-handler) on Amazon EKS cluster.
...
| helm\_chart\_name | Helm chart name to be installed | `string` | `"aws-node-termination-handler"` | no |
| helm\_chart\_version | Version of the Helm chart | `string` | `"0.12.0"` | no |
| helm\_release\_name | Helm release name | `string` | `"aws-node-termination-handler"` | no |
| helm\_repo\_url | Helm repository | `string` | `"https://aws.github.io/eks-charts"` | no |
| k8s\_namespace | The K8s namespace in which the aws-node-termination-handler service account has been created | `string` | `"kube-system"` | no |
...
| settings | Additional settings which will be passed to the Helm chart values, see https://github.com/aws/eks-charts/tree/master/stable/aws-node-termination-handler | `map(any)` | `{}` | no |
